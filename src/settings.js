...
export const LATEST_UPDATE = {
  ...
  title: '새로운 업데이트가 있어요!',
  items: [
    '룰렛 모드 추가: 설정에서 켜면, 대국을 시작할 때 카드를 뽑기 전에 19가지 특수 규칙 중 하나가 무작위로 뽑혀서 그 판 내내 적용돼요. (역전 오목, 파괴전 승리, 색깔 교대전, 배신, 안개 전장 등)',
    '온라인 랜덤 매칭·랭크전에서는 룰렛 모드를 켠 사람끼리만 매칭돼요 (친구와 플레이는 예외).',
  ],
};
