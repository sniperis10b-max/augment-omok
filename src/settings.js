...
export const LATEST_UPDATE = {
  ...
  title: '새로운 업데이트가 있어요!',
  items: [
    '온라인 대전 레이팅 시스템 추가! 기본 1000점에서 시작하고, 상대와 점수 차이에 따라 승/무/패 변동폭이 달라져요.',
    '순위표 추가: 상위 100명의 닉네임과 점수를 볼 수 있어요 (이메일은 절대 표시되지 않아요).',
    '온라인 대전에 무승부 제안 기능 추가',
    '카드 4종 추가: 거래, 낙인, 정화, 메아리',
  ],
};
