...
export const LATEST_UPDATE = {
  ...
  title: '새로운 업데이트가 있어요!',
  items: [
    '챌린지 모드 추가! 메인 화면 "챌린지"에서 핸디캡 10종(무카드, 오목 대 사목, 좁은 시야, 파괴 금지, 방어 금지, 눈 감고 뽑기, 대각선 금지, 6목만 인정, 이중 금수, 흑백 실루엣)과 5단 계단(난이도 5개 연속 클리어)에 도전할 수 있어요.',
    '모든 챌린지를 클리어하면 특별한 "투명 돌" 스킨을 받아요.',
  ],
};
