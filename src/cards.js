...
export const CARDS = [
  ...
  { id: 'moveStone', name: '돌 이동', desc: '내 돌 1개를 다른 빈 칸으로 옮겨요. 이 카드로는 승리를 완성할 수 없어요.', targetType: 'ownThenEmpty', icon: 'Move' },
  ...
  { id: 'headcount', name: '머릿수 싸움', desc: '판 위의 내 돌 개수가 상대보다 적으면 무작위 카드 2장을 즉시 얻어요. 같거나 많으면 아무 효과 없이 소모돼요.', targetType: 'none', icon: 'Users' },
  ...
  { id: 'coinFlip', name: '동전 던지기', desc: '지정한 상대 돌 2개에 각각 50% 확률로 파괴를 시도해요. 둘 다 실패하면 아무 일도 없고, 하나만 성공하면 그 돌 1개, 둘 다 성공하면 2개 모두 파괴돼요.', targetType: 'enemyStone', icon: 'Coins' },
